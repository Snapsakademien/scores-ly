...
tOne = \relative c' {
	...
	\alternative {
		{ es4. es8 g4 g4 | aes2 r2  }
		{ es4. es8 <g bes>4\fermata aes4 | aes2. }
	}
}
...
tTwo = \relative c' {
	...
	\alternative {
		{ c4. aes8 bes4 es4 | es2 s2  }
		{ c4. aes8 bes4 es4 | es2. }
	}
}
...
bOne = \relative c {
	...
	\alternative {
		{ aes4. c8 des4 des4 | c2 s2  }
		{ aes4. c8 des4 des4 | c2. }
	}
}
...
bTwo = \relative c {
	...
	\alternative {
		{ es4. es8 es,4 es4 | aes2 \once \override Voice.Rest.staff-position = #0 r2  }
		{ es'4. es8 es,4\fermata es4 | aes2. }
	}
}
